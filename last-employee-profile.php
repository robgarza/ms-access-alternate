...
<div class="row">
    ...
    <div class="row">
    <div class="col-sm-6">
        <form action="last-employee-profile.php" method="GET">
            <?php
                lastEmployeeProfileRow();            
...
<div class="row mt-3">
  ...
  <path d="M10 12.796V3.204L4.519 8 10 12.796zm-.659.753-5.48-4.796a1 1 0 0 1 0-1.506l5.48-4.796A1 1 0 0 1 11 3.204v9.592a1 1 0 0 1-1.659.753z"/>
            ...
            <button type="submit" name="next-employee-record" value="Next Record" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right" viewBox="0 0 16 16">
  ...
  <path d="M12.5 4a.5.5 0 0 0-1 0v3.248L5.233 3.612C4.713 3.31 4 3.655 4 4.308v7.384c0 .653.713.998 1.233.696L11.5 8.752V12a.5.5 0 0 0 1 0V4zM5 4.633 10.804 8 5 11.367V4.633z"/>
            ...
            <a href="employee-profile.php"><button type="button" name="add-employee-record" value="add-employee-record" class="btn btn-primary">Add Record</button></a>
